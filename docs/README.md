...
- `development.md` lists setup, test, lint, type-check, and release steps.
- `course-notes.md` maps design choices to common grading expectations.

For a quick overview, start with the root `README.md`, then read `architecture.md`.
